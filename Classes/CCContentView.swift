...
class CCContentView: UIView {
    ...
    func setupViews() {
        ...
        brandLabel.font = UIFont(name: "Poppins-Regular", size: 18)
        ...
        numberLabel.font = UIFont(name: "Poppins-Regular", size: 23)
        ...
        nameTitleLabel.text = "Balance"
        nameTitleLabel.font = UIFont(name: "Poppins-Regular", size: 10)
        nameTitleLabel.textColor = UIColor.white
        nameTitleLabel.translatesAutoresizingMaskIntoConstraints = false
        
        nameLabel.text = ""
        nameLabel.font = UIFont(name: "Poppins-Regular", size: 17)
        ...
        expTitleLabel.text = "Due"
        expTitleLabel.font = UIFont(name: "Poppins-Regular", size: 10)
        expTitleLabel.textColor = UIColor.white
        expTitleLabel.translatesAutoresizingMaskIntoConstraints = false
        
        expLabel.text = ""
        expLabel.font = UIFont(name: "Poppins-Regular", size: 17)
